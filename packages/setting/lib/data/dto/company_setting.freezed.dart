...
mixin _$CompanySettingDto {
 ...
 int get id; int get companyId; String get timeZone; bool get isSiteVisitEnabled;
...
@useResult
$Res call({
 int id, int companyId, String timeZone, bool isSiteVisitEnabled
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  int companyId,  String timeZone,  bool isSiteVisitEnabled)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CompanySettingDto() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  int companyId,  String timeZone,  bool isSiteVisitEnabled)  $default,) {final _that = this;
switch (_that) {
case _CompanySettingDto():
return $default(_that.id,_that.companyId,_that.timeZone,_that.isSiteVisitEnabled);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  int companyId,  String timeZone,  bool isSiteVisitEnabled)?  $default,) {final _that = this;
switch (_that) {
case _CompanySettingDto() when $default != null:
return $default(_that.id,_that.companyId,_that.timeZone,_that.isSiteVisitEnabled);case _:
  return null;
...
class _CompanySettingDto implements CompanySettingDto {
  const _CompanySettingDto({required this.id, required this.companyId, required this.timeZone, required this.isSiteVisitEnabled});
  factory _CompanySettingDto.fromJson(Map<String, dynamic> json) => _$CompanySettingDtoFromJson(json);

@override final  int id;
@override final  int companyId;
@override final  String timeZone;
@override final  bool isSiteVisitEnabled;
