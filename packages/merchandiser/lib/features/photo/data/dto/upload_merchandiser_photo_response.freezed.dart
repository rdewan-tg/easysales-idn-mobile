...
mixin _$UploadMerchandiserPhotoResponse {
 ...
 String get status; String get data;
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String status,  String data)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UploadMerchandiserPhotoResponse() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String status,  String data)  $default,) {final _that = this;
switch (_that) {
case _UploadMerchandiserPhotoResponse():
return $default(_that.status,_that.data);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String status,  String data)?  $default,) {final _that = this;
switch (_that) {
case _UploadMerchandiserPhotoResponse() when $default != null:
return $default(_that.status,_that.data);case _:
  return null;
...
class _UploadMerchandiserPhotoResponse implements UploadMerchandiserPhotoResponse {
  const _UploadMerchandiserPhotoResponse({required this.status, required this.data});
