...
mixin _$SiteVisitState {
 ...
 bool get isLoading; bool get isCreated; bool get isUpdated; LatLng? get currentPosition; SiteVisitData? get createSiteVisitResponse; SiteVisitData? get updateSiteVisitResponse; SiteVisitData? get updateSiteVisitNoteResponse; UpdateCustomerLocationData? get updateCustomerLocationResponse; String? get currentAddress; String? get timeNow; Map<String, String> get settings; String? get error;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SiteVisitState&&(identical(other.isLoading, isLoading) || other.isLoading == isLoading)&&(identical(other.isCreated, isCreated) || other.isCreated == isCreated)&&(identical(other.isUpdated, isUpdated) || other.isUpdated == isUpdated)&&(identical(other.currentPosition, currentPosition) || other.currentPosition == currentPosition)&&(identical(other.createSiteVisitResponse, createSiteVisitResponse) || other.createSiteVisitResponse == createSiteVisitResponse)&&(identical(other.updateSiteVisitResponse, updateSiteVisitResponse) || other.updateSiteVisitResponse == updateSiteVisitResponse)&&(identical(other.updateSiteVisitNoteResponse, updateSiteVisitNoteResponse) || other.updateSiteVisitNoteResponse == updateSiteVisitNoteResponse)&&(identical(other.updateCustomerLocationResponse, updateCustomerLocationResponse) || other.updateCustomerLocationResponse == updateCustomerLocationResponse)&&(identical(other.currentAddress, currentAddress) || other.currentAddress == currentAddress)&&(identical(other.timeNow, timeNow) || other.timeNow == timeNow)&&const DeepCollectionEquality().equals(other.settings, settings)&&(identical(other.error, error) || other.error == error));
}


@override
int get hashCode => Object.hash(runtimeType,isLoading,isCreated,isUpdated,currentPosition,createSiteVisitResponse,updateSiteVisitResponse,updateSiteVisitNoteResponse,updateCustomerLocationResponse,currentAddress,timeNow,const DeepCollectionEquality().hash(settings),error);

@override
String toString() {
  return 'SiteVisitState(isLoading: $isLoading, isCreated: $isCreated, isUpdated: $isUpdated, currentPosition: $currentPosition, createSiteVisitResponse: $createSiteVisitResponse, updateSiteVisitResponse: $updateSiteVisitResponse, updateSiteVisitNoteResponse: $updateSiteVisitNoteResponse, updateCustomerLocationResponse: $updateCustomerLocationResponse, currentAddress: $currentAddress, timeNow: $timeNow, settings: $settings, error: $error)';
}
...
@useResult
$Res call({
 bool isLoading, bool isCreated, bool isUpdated, LatLng? currentPosition, SiteVisitData? createSiteVisitResponse, SiteVisitData? updateSiteVisitResponse, SiteVisitData? updateSiteVisitNoteResponse, UpdateCustomerLocationData? updateCustomerLocationResponse, String? currentAddress, String? timeNow, Map<String, String> settings, String? error
});


$LatLngCopyWith<$Res>? get currentPosition;$SiteVisitDataCopyWith<$Res>? get createSiteVisitResponse;$SiteVisitDataCopyWith<$Res>? get updateSiteVisitResponse;$SiteVisitDataCopyWith<$Res>? get updateSiteVisitNoteResponse;$UpdateCustomerLocationDataCopyWith<$Res>? get updateCustomerLocationResponse;
...
/// Create a copy of SiteVisitState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? isLoading = null,Object? isCreated = null,Object? isUpdated = null,Object? currentPosition = freezed,Object? createSiteVisitResponse = freezed,Object? updateSiteVisitResponse = freezed,Object? updateSiteVisitNoteResponse = freezed,Object? updateCustomerLocationResponse = freezed,Object? currentAddress = freezed,Object? timeNow = freezed,Object? settings = null,Object? error = freezed,}) {
...
as SiteVisitData?,updateSiteVisitNoteResponse: freezed == updateSiteVisitNoteResponse ? _self.updateSiteVisitNoteResponse : updateSiteVisitNoteResponse // ignore: cast_nullable_to_non_nullable
as SiteVisitData?,updateCustomerLocationResponse: freezed == updateCustomerLocationResponse ? _self.updateCustomerLocationResponse : updateCustomerLocationResponse // ignore: cast_nullable_to_non_nullable
as UpdateCustomerLocationData?,currentAddress: freezed == currentAddress ? _self.currentAddress : currentAddress // ignore: cast_nullable_to_non_nullable
...
@override
@pragma('vm:prefer-inline')
$SiteVisitDataCopyWith<$Res>? get updateSiteVisitNoteResponse {
    if (_self.updateSiteVisitNoteResponse == null) {
    return null;
  }

  return $SiteVisitDataCopyWith<$Res>(_self.updateSiteVisitNoteResponse!, (value) {
    return _then(_self.copyWith(updateSiteVisitNoteResponse: value));
  });
}/// Create a copy of SiteVisitState
/// with the given fields replaced by the non-null parameter values.
@override
@pragma('vm:prefer-inline')
$UpdateCustomerLocationDataCopyWith<$Res>? get updateCustomerLocationResponse {
    if (_self.updateCustomerLocationResponse == null) {
    return null;
  }

  return $UpdateCustomerLocationDataCopyWith<$Res>(_self.updateCustomerLocationResponse!, (value) {
    return _then(_self.copyWith(updateCustomerLocationResponse: value));
  });
}
}
...
switch (_that) {
case _SiteVisitState() when $default != null:
return $default(_that.isLoading,_that.isCreated,_that.isUpdated,_that.currentPosition,_that.createSiteVisitResponse,_that.updateSiteVisitResponse,_that.updateSiteVisitNoteResponse,_that.updateCustomerLocationResponse,_that.currentAddress,_that.timeNow,_that.settings,_that.error);case _:
  return orElse();
...
class _SiteVisitState implements SiteVisitState {
   _SiteVisitState({this.isLoading = false, this.isCreated = false, this.isUpdated = false, this.currentPosition, this.createSiteVisitResponse, this.updateSiteVisitResponse, this.updateSiteVisitNoteResponse, this.updateCustomerLocationResponse, this.currentAddress, this.timeNow, final  Map<String, String> settings = const {}, this.error}): _settings = settings;
...
@override final  SiteVisitData? updateSiteVisitNoteResponse;
@override final  UpdateCustomerLocationData? updateCustomerLocationResponse;
...
@override
int get hashCode => Object.hash(runtimeType,isLoading,isCreated,isUpdated,currentPosition,createSiteVisitResponse,updateSiteVisitResponse,updateSiteVisitNoteResponse,updateCustomerLocationResponse,currentAddress,timeNow,const DeepCollectionEquality().hash(_settings),error);
...
@override $LatLngCopyWith<$Res>? get currentPosition;@override $SiteVisitDataCopyWith<$Res>? get createSiteVisitResponse;@override $SiteVisitDataCopyWith<$Res>? get updateSiteVisitResponse;@override $SiteVisitDataCopyWith<$Res>? get updateSiteVisitNoteResponse;@override $UpdateCustomerLocationDataCopyWith<$Res>? get updateCustomerLocationResponse;
