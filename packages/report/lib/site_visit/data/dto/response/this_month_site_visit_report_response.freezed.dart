...
mixin _$ThisMonthSiteVisitReportResponse {
 ...
 String get status; ThisMonthSiteVisitReportData get data;
...
@useResult
$Res call({
 String status, ThisMonthSiteVisitReportData data
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String status,  ThisMonthSiteVisitReportData data)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ThisMonthSiteVisitReportResponse() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String status,  ThisMonthSiteVisitReportData data)  $default,) {final _that = this;
switch (_that) {
case _ThisMonthSiteVisitReportResponse():
return $default(_that.status,_that.data);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String status,  ThisMonthSiteVisitReportData data)?  $default,) {final _that = this;
switch (_that) {
case _ThisMonthSiteVisitReportResponse() when $default != null:
return $default(_that.status,_that.data);case _:
  return null;
...
class _ThisMonthSiteVisitReportResponse implements ThisMonthSiteVisitReportResponse {
  const _ThisMonthSiteVisitReportResponse({required this.status, required this.data});
...
@override final  ThisMonthSiteVisitReportData data;
...
mixin _$ThisMonthSiteVisitReportData {
 ...
 int get totalUniqueVisits; List<ThisMonthSiteVisitDetail> get visitDetails;
...
@useResult
$Res call({
 int totalUniqueVisits, List<ThisMonthSiteVisitDetail> visitDetails
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int totalUniqueVisits,  List<ThisMonthSiteVisitDetail> visitDetails)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ThisMonthSiteVisitReportData() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int totalUniqueVisits,  List<ThisMonthSiteVisitDetail> visitDetails)  $default,) {final _that = this;
switch (_that) {
case _ThisMonthSiteVisitReportData():
return $default(_that.totalUniqueVisits,_that.visitDetails);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int totalUniqueVisits,  List<ThisMonthSiteVisitDetail> visitDetails)?  $default,) {final _that = this;
switch (_that) {
case _ThisMonthSiteVisitReportData() when $default != null:
return $default(_that.totalUniqueVisits,_that.visitDetails);case _:
  return null;
...
class _ThisMonthSiteVisitReportData implements ThisMonthSiteVisitReportData {
  const _ThisMonthSiteVisitReportData({required this.totalUniqueVisits, required final  List<ThisMonthSiteVisitDetail> visitDetails}): _visitDetails = visitDetails;
  factory _ThisMonthSiteVisitReportData.fromJson(Map<String, dynamic> json) => _$ThisMonthSiteVisitReportDataFromJson(json);

@override final  int totalUniqueVisits;
 final  List<ThisMonthSiteVisitDetail> _visitDetails;
@override List<ThisMonthSiteVisitDetail> get visitDetails {
...
mixin _$ThisMonthSiteVisitDetail {
 ...
 String get customerId; String get customerName; String get customerAddress; int get visitCount;
...
@useResult
$Res call({
 String customerId, String customerName, String customerAddress, int visitCount
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String customerId,  String customerName,  String customerAddress,  int visitCount)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ThisMonthSiteVisitDetail() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String customerId,  String customerName,  String customerAddress,  int visitCount)  $default,) {final _that = this;
switch (_that) {
case _ThisMonthSiteVisitDetail():
return $default(_that.customerId,_that.customerName,_that.customerAddress,_that.visitCount);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String customerId,  String customerName,  String customerAddress,  int visitCount)?  $default,) {final _that = this;
switch (_that) {
case _ThisMonthSiteVisitDetail() when $default != null:
return $default(_that.customerId,_that.customerName,_that.customerAddress,_that.visitCount);case _:
  return null;
...
class _ThisMonthSiteVisitDetail implements ThisMonthSiteVisitDetail {
  const _ThisMonthSiteVisitDetail({required this.customerId, required this.customerName, required this.customerAddress, required this.visitCount});
