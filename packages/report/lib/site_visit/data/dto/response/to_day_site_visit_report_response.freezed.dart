...
mixin _$ToDaySiteVisitReportResponse {
 ...
 String get status; ToDaySiteVisitReportData get data;
...
@useResult
$Res call({
 String status, ToDaySiteVisitReportData data
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String status,  ToDaySiteVisitReportData data)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ToDaySiteVisitReportResponse() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String status,  ToDaySiteVisitReportData data)  $default,) {final _that = this;
switch (_that) {
case _ToDaySiteVisitReportResponse():
return $default(_that.status,_that.data);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String status,  ToDaySiteVisitReportData data)?  $default,) {final _that = this;
switch (_that) {
case _ToDaySiteVisitReportResponse() when $default != null:
return $default(_that.status,_that.data);case _:
  return null;
...
class _ToDaySiteVisitReportResponse implements ToDaySiteVisitReportResponse {
  const _ToDaySiteVisitReportResponse({required this.status, required this.data});
  factory _ToDaySiteVisitReportResponse.fromJson(Map<String, dynamic> json) => _$ToDaySiteVisitReportResponseFromJson(json);

@override final  String status;
@override final  ToDaySiteVisitReportData data;
...
mixin _$ToDaySiteVisitReportData {
 ...
 int get totalUniqueVisits; List<ToDaySiteVisitDetail> get visitDetails;
...
@useResult
$Res call({
 int totalUniqueVisits, List<ToDaySiteVisitDetail> visitDetails
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int totalUniqueVisits,  List<ToDaySiteVisitDetail> visitDetails)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ToDaySiteVisitReportData() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int totalUniqueVisits,  List<ToDaySiteVisitDetail> visitDetails)  $default,) {final _that = this;
switch (_that) {
case _ToDaySiteVisitReportData():
return $default(_that.totalUniqueVisits,_that.visitDetails);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int totalUniqueVisits,  List<ToDaySiteVisitDetail> visitDetails)?  $default,) {final _that = this;
switch (_that) {
case _ToDaySiteVisitReportData() when $default != null:
return $default(_that.totalUniqueVisits,_that.visitDetails);case _:
  return null;
...
class _ToDaySiteVisitReportData implements ToDaySiteVisitReportData {
  const _ToDaySiteVisitReportData({required this.totalUniqueVisits, required final  List<ToDaySiteVisitDetail> visitDetails}): _visitDetails = visitDetails;
...
@override List<ToDaySiteVisitDetail> get visitDetails {
...
mixin _$ToDaySiteVisitDetail {
 ...
 String get customerId; String get customerName; String get customerAddress;
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String customerId,  String customerName,  String customerAddress)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ToDaySiteVisitDetail() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String customerId,  String customerName,  String customerAddress)  $default,) {final _that = this;
switch (_that) {
case _ToDaySiteVisitDetail():
return $default(_that.customerId,_that.customerName,_that.customerAddress);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String customerId,  String customerName,  String customerAddress)?  $default,) {final _that = this;
switch (_that) {
case _ToDaySiteVisitDetail() when $default != null:
return $default(_that.customerId,_that.customerName,_that.customerAddress);case _:
  return null;
...
class _ToDaySiteVisitDetail implements ToDaySiteVisitDetail {
  const _ToDaySiteVisitDetail({required this.customerId, required this.customerName, required this.customerAddress});
