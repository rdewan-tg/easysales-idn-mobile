...
mixin _$ProductPriceResponse {
 ...
 String get status; int get total; List<ProductPriceData> get data;
...
@useResult
$Res call({
 String status, int total, List<ProductPriceData> data
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String status,  int total,  List<ProductPriceData> data)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ProductPriceResponse() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String status,  int total,  List<ProductPriceData> data)  $default,) {final _that = this;
switch (_that) {
case _ProductPriceResponse():
return $default(_that.status,_that.total,_that.data);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String status,  int total,  List<ProductPriceData> data)?  $default,) {final _that = this;
switch (_that) {
case _ProductPriceResponse() when $default != null:
return $default(_that.status,_that.total,_that.data);case _:
  return null;
...
class _ProductPriceResponse implements ProductPriceResponse {
  const _ProductPriceResponse({required this.status, required this.total, required final  List<ProductPriceData> data}): _data = data;
...
@override List<ProductPriceData> get data {
...
mixin _$ProductPriceData {
 ...
 int get id; String get productId; String get itemId; String? get packSize; DateTime get fromDate; DateTime get toDate; String get unitPrice; String get currencyCode; String get salesUnit; String get priceGroup; String get recId; int get companyId; String get companyCode; DateTime get createAt; DateTime get updatedAt;
...
@useResult
$Res call({
 int id, String productId, String itemId, String? packSize, DateTime fromDate, DateTime toDate, String unitPrice, String currencyCode, String salesUnit, String priceGroup, String recId, int companyId, String companyCode, DateTime createAt, DateTime updatedAt
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String productId,  String itemId,  String? packSize,  DateTime fromDate,  DateTime toDate,  String unitPrice,  String currencyCode,  String salesUnit,  String priceGroup,  String recId,  int companyId,  String companyCode,  DateTime createAt,  DateTime updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ProductPriceData() when $default != null:
...
class _ProductPriceData implements ProductPriceData {
  const _ProductPriceData({required this.id, required this.productId, required this.itemId, this.packSize, required this.fromDate, required this.toDate, required this.unitPrice, required this.currencyCode, required this.salesUnit, required this.priceGroup, required this.recId, required this.companyId, required this.companyCode, required this.createAt, required this.updatedAt});
